defmodule Telluride.Messaging.PipelineThroughputQueue do

  @exchange         "broadway_events"

  @msg_queue        "broadway_throughput_queue"
  @msg_routing_key  "broadway.throughput"
